...
//
// Решение §6.8 и §6.9 для обеих ОС уже есть и проверено без прав
// (internal/loopguard): имя интерфейса для sockopt.interface и блокировка
// глобального IPv6. Нет исполнителя — того, кто создаст интерфейс и выполнит
// план.
//
