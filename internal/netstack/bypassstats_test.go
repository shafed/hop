...
// Тот же фолд, но на настоящем bypass.NAT: утверждение здесь — что приёмник
// продукта действительно попадает в необязательный интерфейс. Проверка типа
// промахивается молча (нулями), и один только тест с подставным приёмником
// зеленел бы при разъехавшейся сигнатуре Stats.
//
